...
try {
    $pdo = new PDO(
        "mysql:host=127.0.0.1;port=3306;dbname=sms_shortcode",
        "root",
        "",
        [
...
<nav class="navbar navbar-dark bg-dark px-4">
    ...
    <div class="d-flex gap-2">
        ...
        <a class="btn btn-outline-light btn-sm" href="../whatsapp_simulate.php">
            <i class="bi bi-whatsapp me-1"></i>WhatsApp Simulator
        </a>
...
<div class="mb-2">
Logged in as: <strong><?= htmlspecialchars($_SESSION['technician_name'] ?? $_SESSION['user']) ?></strong>
<?php if (($_SESSION['role'] ?? '') === 'technician' && !empty($_SESSION['technician_district'])): ?>
    <span class="text-muted">(<?= htmlspecialchars($_SESSION['technician_district']) ?>)</span>
<?php endif; ?>
</div>
...
<button class="btn btn-success btn-sm" name="update_status">Resolve</button>
</form>
